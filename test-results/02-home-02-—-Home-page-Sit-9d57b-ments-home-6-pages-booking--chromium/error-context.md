...
- Name: 02-home.spec.ts >> 02 — Home page >> SiteNav has 8 link elements (home + 6 pages + booking)
- Location: tests/e2e/02-home.spec.ts:97:7
...
Locator:  locator('nav[aria-label="Principal"]').first().locator('a')
Expected: 8
Received: 9
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('nav[aria-label="Principal"]').first().locator('a')
