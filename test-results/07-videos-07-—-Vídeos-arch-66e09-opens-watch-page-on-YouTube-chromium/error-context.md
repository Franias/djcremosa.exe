...
- Name: 07-videos.spec.ts >> 07 — Vídeos >> archive video card opens watch page on YouTube
- Location: tests/e2e/07-videos.spec.ts:138:7
...
Locator: getByRole('link', { name: /assistir/i }).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: /assistir/i }).first()
