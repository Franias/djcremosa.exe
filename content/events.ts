...
export const events: CremosaEvent[] = [
  // ─────── UPCOMING ───────
  {
    slug: "rockwork-2026-09-04",
    title: "Rockwork /// Clube de Corrida",
    date: "2026-09-04",
    venue: "Ocidente",
    city: "Porto Alegre",
    region: "RS",
    ...
    status: "confirmed",
    category: "party",
    lineup: ["Cremosa", "Guto Hayata", "Reantta"],
    ticketUrl:
      "https://www.sympla.com.br/evento/rockwork-clube-de-corrida/3542347",
    note: "Pista Academia — #summer #suor #eletrohits · Dresscode: atleta amador.",
  },
  {
    slug: "lesbilab-baile-funk-2-2026-09-04",
    title: "Lesbilab /// Baile Funk (Edição Baile Funk)",
    date: "2026-09-04",
    time: "23h",
    venue: "Floresta",
    city: "Porto Alegre",
    ...
    status: "confirmed",
    category: "club",
    lineup: ["Coppetti", "Cremosa", "Taay Melo", "Luizza", "Ju Klein"],
    ticketUrl: "https://shotgun.live/pt-br/events/lesbilab-baile-funk-2",
    note: ".",
  },
  {
    slug: "midnight-3-2026-09-05",
    title: "Midnight /// 3",
    date: "2026-09-05",
    time: "22h",
    venue: "Cidade 9 — Av. Venâncio Aires, 240 (Cidade Baixa)",
    city: "Porto Alegre",
    region: "RS",
    country: "Brasil",
    status: "confirmed",
    category: "party",
    lineup: ["MD Plince", "Dig Djow", "Cremosa", "Dj Santi"],
    ticketUrl: "https://www.sympla.com.br/evento/midnight-3/3535384",
    note: "Pocket shows: Grupo Soul, Nyck Lopes · 22h às 6h.",
  },
  {
    slug: "fancy-festival-1-ano-2026-09-12",
    title: "Fancy Festival /// 1 Ano · 6 Festas · 2 Pistas · 1 Noite",
    date: "2026-09-12",
    time: "tba",
    venue: "Secreto — Centro Histórico",
    city: "Porto Alegre",
    region: "RS",
    country: "Brasil",
    status: "confirmed",
    ...
    lineup: ["Cremosa"],
    ticketUrl:
      "https://shotgun.live/pt-br/festivals/fancy-festival-1-ano-6-festas-2-pistas",
    note: "Abertura 22h30 · Line-up completo a anunciar · Locação secreta.",
  },
  {
    slug: "evento-fechado-nalu-care-2026-09-26",
    title: "Evento Fechado",
    date: "2026-09-26",
    venue: "NALU CARE Beauty",
    city: "Esteio",
    region: "RS",
    country: "Brasil",
    status: "confirmed",
